...
- Calculate relevant parameter statistics using accepted samples obtained from fitting using DE-MC.
...
and its output can be written to a text file by setting write_out=True in the function argument for further analysis.
"""
import numpy as np
from funcs import *

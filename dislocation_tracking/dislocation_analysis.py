...
as input the text files generated by "ovito_disloc.py", the format of which is described in
...
to "track" a given dislocation throught a trajectory and analyse its dynamics.

The script "dislocation_script.py" and its documentation show how the other functions in this module
can be used to carry out the necessary processing of dislocation trajectories prior to carrying out 
the dislocation tracking using "track_disloc".
"""

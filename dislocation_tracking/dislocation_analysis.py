...
as input the text files generated by @ref ovito_disloc.py, which uses the OVITO Dislocation Analysis (DXA)
tool to detect dislocations. The format of the text files generated by @ref ovito_disloc.py is described in
